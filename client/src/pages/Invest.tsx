                  ...
                  <div className="p-4">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      {plan.isUnlocked === false ? (
                        <span className="text-xs px-2 py-1 rounded-full font-semibold bg-gray-100 text-gray-500">
                          🔒 Locked
                        </span>
                      ) : (
                    ...
                    <button
                      onClick={() => canRent && plan.isUnlocked !== false && handleRent(plan.id)}
                      disabled={!canRent || plan.isUnlocked === false || rentMutation.isPending}
