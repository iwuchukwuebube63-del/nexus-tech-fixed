          ...
          >
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="bg-orange-100 border-l-4 border-orange-500 p-4 rounded">
                ...
                <p className="text-xl font-bold text-orange-700">{withdrawalFeePercent}% per withdrawal</p>
                <p className="text-xs text-orange-500 mt-0.5">Deducted automatically from withdrawal amount</p>
              </div>
              ...
              <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded">
                ...
                <div className="space-y-1 mt-2">
                  <p className="text-sm font-semibold text-yellow-700">
                    Level 1: {referralBonusLevel1}% of referral investment
                  </p>
                  <p className="text-sm font-semibold text-yellow-700">
                    Level 2: {referralBonusLevel2}% of referral investment
                  </p>
                </div>
              </div>
