...
const ANNOUNCEMENT_KEY = "nexus_announcement_dismissed_v1";
...
🔥 Your earnings automatically arrive in your balance every night at 00:00 AM.

💵 Withdrawals available: 9:00 AM to 6:00 PM daily.

📋 Key Information:
• Withdrawal hours: 9:00 AM – 6:00 PM
• Withdrawal tax: 10%
...
export function AnnouncementPopup() {
  ...
  useEffect(() => {
    // Show once per session (not every page visit)
